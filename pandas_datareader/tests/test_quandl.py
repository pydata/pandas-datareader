...
class TestQuandl(object):
    ...
    def test_db_fse_frankfurt(self):
        ...
        self.check_headers(df, ['Open', 'High', 'Low', 'Close', 'Change',
                                'TradedVolume', 'Turnover', 'LastPriceoftheDay',
                                'DailyTradedUnits', 'DailyTurnover'])
    ...
    def test_db_hkex_cn(self):
        ...
        print("HKEX/00941:\n", df)
        self.check_headers(df,
                ['NominalPrice', 'NetChange', 'Change', 'Bid', 'Ask', 'PEx',
                 'High', 'Low', 'PreviousClose', 'ShareVolume000',
                 'Turnover000', 'LotSize'])
        assert df.High.at[self.day2] == 91.90
