...
from pandas_datareader.commons import _in_chunks, _sanitize_dates, \
    _retry_read_url, _dl_mult_symbols, _get_data_from

from pandas_datareader.google.hist import get_data_google
...
from pandas_datareader.yahoo.daily import get_data_yahoo
